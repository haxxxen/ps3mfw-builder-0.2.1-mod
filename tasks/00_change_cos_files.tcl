...
namespace eval 00_change_cos_files {
    array set ::00_change_cos_files::options {
        --change-coreos-files true
    }
    proc main {} {
		log "WARNING: Playing with COREOS Files only on your own Risk and NOT WITHOUT Flasher !!!" 1
        variable options
        if {$::00_change_cos_files::options(--change-coreos-files)} {
			set coreos "creserved_0"
				::modify_coreos_file $coreos ::00_change_cos_files::change_file
		}
	}
