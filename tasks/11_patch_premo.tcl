...
namespace eval ::11_patch_premo {

    array set ::11_patch_premo::options {
      --patch-premo true
      --patch-game true
    }
    ...
    proc patch_game {self} {
		::modify_self_file $self ::11_patch_premo::game_elf
	}
    proc game_elf {elf} {
        if {$::11_patch_premo::options(--patch-game) } {
			log "Patching [file tail $elf] with Pattern"
