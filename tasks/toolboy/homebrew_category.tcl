...
# Option --homebrew-title: Category Name to set

# Type --homebrew-cat: combobox {{Users} {Photo} {Music} {Video} {TV} {Game} {Network} {PlayStation® Network} {Friends}}
# Type --homebrew-title: combobox {{Homebrew} {Hacks} {Tools} {Apps} {Multimedia} {Retro} {Manager}}
...
namespace eval ::homebrew_category {
	...
	proc callback_homebrew {path args} {		
		...
		set name $::homebrew_category::options(--homebrew-title)
        sed_in_place [file join $path English.xml] $::homebrew_category::options(--homebrew-cat) $name	
	}
}